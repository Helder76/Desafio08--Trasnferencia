...
import { CreateTransfersController } from '../modules/statements/useCases/createTransfer/CreateTransfersController';
...
statementRouter.post('/transfer/:receiver_id', createTransfersController.execute);
